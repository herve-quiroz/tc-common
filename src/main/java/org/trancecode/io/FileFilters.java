...
/**
 * Utility methods related to {@link FileFilter}.
 * 
 * @author Herve Quiroz
 */
public final class FileFilters
{
    ...
    {
        return IsDirectoryFileFilter.INSTANCE;
    }

    private static final class IsDirectoryFileFilter implements FileFilter
    {
        private static final IsDirectoryFileFilter INSTANCE = new IsDirectoryFileFilter();
