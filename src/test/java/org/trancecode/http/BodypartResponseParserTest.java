...
public class BodypartResponseParserTest
{
    ...
    public void testParse() throws Exception
    {
        ...
        final BodypartResponseParser parser = new BodypartResponseParser(stream, "=-=-=-=-=", null, "multipart/mixed",
                "utf-8");
        ...
        final String test = Base64.encodeBytes(IOUtils.toByteArray(entities.get(1).getEntity().getContent()),
